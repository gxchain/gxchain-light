...
const routes = (
    <Route path="/" component={App} onEnter={willTransitionTo}>
        ...
        <Route path="data-market" getComponent={(location, cb) => {
            System.import("components/DataMarket/DataMarket").then(loadRoute(cb)).catch(errorLoading);
        }} >
            <IndexRoute getComponent={(location, cb) => {
                System.import("components/DataMarket/DataMarket").then(loadRoute(cb)).catch(errorLoading);
            }}/>
            <Route path="Free/:id" getComponent={(location, cb) => {
                System.import("components/DataMarket/DataMarketDetail").then(loadRoute(cb)).catch(errorLoading);
            }}/>
            <Route path="League/:id" getComponent={(location, cb) => {
                System.import("components/DataMarket/LeagueDetail").then(loadRoute(cb)).catch(errorLoading);
            }}/>
        </Route>
        ...
        <Route path="/account/:account_name" getComponent={(location, cb) => {
            ...
            <Route path="merchant-verify" getComponent={(location, cb) => {
                System.import("components/Account/GXBMerchantVerify").then(loadRoute(cb)).catch(errorLoading);
            }}/>
            <Route path="data-source-verify" getComponent={(location, cb) => {
                System.import("components/Account/GXBDataSourceVerify").then(loadRoute(cb)).catch(errorLoading);
            }}/>
        </Route>
        {/*<Route path="deposit-withdraw" getComponent={(location, cb) => {
            System.import("components/Account/AccountDepositWithdraw").then(loadRoute(cb)).catch(errorLoading);

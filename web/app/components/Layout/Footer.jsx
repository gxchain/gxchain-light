        ...
        return (
            <div className="show-for-medium grid-block shrink footer">
                <div className="align-justify grid-block">
                    ...
                    {this.props.synced ? null : <div className="grid-block shrink txtlabel error"><Translate
                        content="footer.nosync"/>&nbsp; &nbsp;</div>}
                    {this.props.rpc_connection_status === "closed" ?
                        <div className="grid-block shrink txtlabel error"><Translate
                            content="footer.connection"/>&nbsp; &nbsp;</div> : null}
                    {needsUpgrade ? <span>
                        <div className="grid-block">
                            <a className="shrink txtlabel facolor-alert"
                               data-tip="检测到新的版本,强烈建议点击升级"
                               data-type="warning"
                               onClick={this.onUpgrade.bind(this)}><Translate content="footer.upgrade"/></a>
                            &nbsp;&nbsp;
                        </div>
                    </span> : null}

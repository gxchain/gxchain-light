    ...
    render() {
        ...
        return (
            <tr>
                ...
                {onRemove ? <td>
                    <button onClick={onRemove.bind(this, account.get("id"))} className="button outline">Remove</button>
                </td> : null}
            </tr>
        );
    }
                        ...
                        <Tab title="account.whitelist.title">
                            <div style={{paddingBottom: "1rem"}} className="small-12">
                                ...
                                {!account.get("whitelisted_accounts") ?
                                    <p className="has-error">Please note, whitelisting is not working yet due to
                                        unresolved backend issue.</p> : null}

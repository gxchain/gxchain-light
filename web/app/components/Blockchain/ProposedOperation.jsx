        ...
        switch (ops[op[0]]) { // For a list of trx types, see chain_types.coffee
            ...
            case "asset_settle":
                ...
                column = (
                    <span>
                        ...
                        &nbsp;<FormattedAsset style={{fontWeight: "bold"}} amount={op[1].amount.amount}
            ...
            case "fill_order":
                ...
                column = (
                    <span>
                        ...
                        &nbsp;<FormattedAsset style={{fontWeight: "bold"}} amount={op[1].pays.amount}
                                              asset={op[1].pays.asset_id}/>
                        &nbsp;<Translate component="span" content="proposal.obtain"/>
                        &nbsp;<FormattedAsset style={{fontWeight: "bold"}} amount={op[1].receives.amount}
                ...
                if (current === op[1].lender) {
                    column = (
                        <span>
                            ...
                            &nbsp;<FormattedAsset style={{fontWeight: "bold"}} amount={op[1].amount_borrowed.amount}
                ...
                if (current === op[1].lender) {
                    column = (
                        <span>
                            ...
                            &nbsp;<FormattedAsset style={{fontWeight: "bold"}} amount={op[1].collateral_claimed.amount}
            ...
            case 'account_upgrade_merchant':
                column = (
                    <span>
                            <TranslateWithLinks
                                string={"proposal.account_upgrade_merchant"}
                                keys={[
            ...
            case 'account_upgrade_datasource':
                column = (
                    <span>
                            <TranslateWithLinks
                                string={"proposal.account_upgrade_datasource"}
                                keys={[
                                    {type: "account", value: '1.2.0', arg: "issuer"},
                                    {type: "account", value: op[1].account_to_upgrade, arg: "account"}
                                ]}

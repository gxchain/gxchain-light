...
class Statistics extends React.Component {
    ...
    componentDidMount() {
        let self = this;
        document.getElementById('bodyBox').parentNode.parentNode.onscroll = function(){
            let current_y = document.getElementById('bodyBox').parentNode.parentNode.scrollTop;
        ...
        let timer = setTimeout(function(){
            ...
            if (tar_y>=current_y){ //tar_y > current_y 即向下滚动
                ...
                if(next_y<=tar_y){  //向上滚动和向下滚动判定的区别 是这里！！
                    document.getElementById('bodyBox').parentNode.parentNode.scrollTop = next_y;
                    self.scroll_To(tar_y)
                }
                else{
                    document.getElementById('bodyBox').parentNode.parentNode.scrollTop = tar_y;
                    clearTimeout(timer)
                }
            }
